<template>
	<div>
		...
		<div v-else>
			<PaymentBar :isTryScan="isCourseType" :columnDetail="columnDetail" :groupBuyId="groupBuyId" :collectLikeId="collectLikeId"
			 :userAccessStatus="userAccessStatus" :callback="fetchColumnData" :key="courseId+groupBuyId+collectLikeId+userAccessStatus" />
			<div id="detailmain" ref="detailmain" v-if="!isReadType">
				...
				<div class="column-base">
					...
					<SingleSetItem v-for="item of columnDetail.freeLessonList" :key="item.id" :item="item" :courseid="courseId"
			...
			<div v-else>
				...
				<!-- 5. 作品单集/章集 播放列表 -->
				<van-list v-model="refreshing" :finished="lessonFinished" :immediate-check="true" @load="scrollBottom" @offset="3">
					<SingleSetList :courseid="courseId" :list="lessonList" :play-id="playingId" :columnType="columnType" :coursename="columnDetail.name"
