	...
	<div>
		...
		<div class="index" v-else>
			<div>
				<van-swipe :autoplay="4000" class="index-swiper">
					<van-swipe-item v-for="list in bannerList" :key="list.url">
						<i class="qhht-icon lazy-img-larger index-swiper-img" v-lazy:background-image="`${list.url}?imageView2/1/format/jpg`"
						 @click="routerToSwiperDetail(list)"></i>
					</van-swipe-item>
			...
			<div class="index-container">
				<HomeItem v-for="item of Object.keys(homeColumnList)" :key="item" :item="homeColumnList[item]" :columnType="item"
