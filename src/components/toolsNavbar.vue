<template>
	<div class="purchase-toolbar" v-show="toolsObject&&toolsObject.isShow">
		...
		<div v-show="toolsObject&&toolsObject.originPrice" :disabled="isLoading" class="toolbar-price" :class="{'toolbar-price-active':toolsObject&&!toolsObject.collage&&!toolsObject.collect }"
		 @click="clickOriginPriceBtn">
